...
function beb_customize_register( WP_Customize_Manager $wp_customize ): void {
	...
	$settings = array(
		...
		'beb_venmo_url'        => array(
			'default'     => 'https://venmo.com/u/YOUR_VENMO_HANDLE',
			'label'       => __( 'Venmo payment link', 'big-easy-bodega' ),
			'type'        => 'url',
		),
		'beb_paypal_url'       => array(
			'default'     => 'https://paypal.me/YOUR_PAYPAL_HANDLE',
			'label'       => __( 'PayPal payment link', 'big-easy-bodega' ),
			'type'        => 'url',
		),
		'beb_cashapp_url'      => array(
			'default'     => 'https://cash.app/$YOUR_CASHAPP_HANDLE',
			'label'       => __( 'Cash App payment link', 'big-easy-bodega' ),
			'type'        => 'url',
		),
		'beb_applepay_url'     => array(
			'default'     => 'https://apple.com/apple-pay/',
			'label'       => __( 'Apple Pay / instructions link', 'big-easy-bodega' ),
			'type'        => 'url',
			'description' => __( 'Placeholder for v1 — link residents to your Apple Pay instructions page or contact method.', 'big-easy-bodega' ),
		),
		'beb_payment_note'     => array(
			'default'     => __( 'Pay the order total using one of the links below. Include your apartment number in the payment note. We will mark your order as processing once payment is confirmed, and your door code will appear on the order confirmation page.', 'big-easy-bodega' ),
